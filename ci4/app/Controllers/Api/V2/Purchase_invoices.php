...
class Purchase_invoices extends ResourceController
{
    /**
    ...
    public function index()
    {
        ...
        $data['data'] = $api->purchase_invoice_model->getApiV2Invoice($_GET['uuid_business_id']);
        $data['total'] = $api->common_model->getCount('purchase_invoices', $arr);
        $data['message'] = 200;
    ...
    {
        $api =  new Api_v2();
        $data['data'] = $api->purchase_invoice_model->getApiV2SingleInvoice($id);
        $data['message'] = 200;
        return $this->respond($data);
    }
    ...
    {
        $api =  new Api_v2();
        return $this->respond($api->addPurchaseInvoice());
    }
    ...
    {
        $api =  new Api_v2();
        return $this->respond($api->updatePurchaseInvoice());
    }
    ...
    {
        $api =  new Api_v2();
        $data['data'] = $api->common_model->deleteTableData('purchase_invoices', $id, 'uuid');
        $data['status'] = 200;
        return $this->respond($data);
    }
}
