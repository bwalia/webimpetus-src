...
class Media extends ResourceController
{
    ...
    public function index()
    {
        ...
        $data['total'] = $api->common_model->getCount('media_list',$arr);
        $data['message'] = 200;
    ...
    {
        $api =  new Api_v2();
        $data['data'] = $api->common_model->getRow('media_list',$id,'id');
        $data['message'] = 200;
        return $this->respond($data);
    }
    ...
    {       
        $api =  new Api_v2();
        $data['data'] = $api->common_model->deleteTableData('media_list',$id,'id');
        $data['status'] = 200;
        return $this->respond($data);    
    }
}
