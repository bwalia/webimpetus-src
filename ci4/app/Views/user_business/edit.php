        ...
        <form action="/user_business/update" method="post" id="userform">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <select id="user_id" name="user_id" class="form-control select2" <?php if ($uriSegment and !empty($uriSegment) and isset($uriSegment)) {
                ...
                <div class="form-group col-md-12">
                    ...
                    <select id="primary_business_uuid" name="primary_business_uuid" class="form-control">
                        ...
                        foreach ($userBusiness as $row): ?>
                            ...
                            <option value="<?= $row->uuid; ?>" <?= ($row->uuid == @$result[0]->primary_business_uuid ? 'selected' : '') ?>>
                                <?= $row->name; ?>
                            </option>
                            <?php //} ?>
                        <?php endforeach; ?>
