            ...
            <form id="addcustomer" method="post" action=<?php echo "/".$tableName."/update";?> enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <div class="form-group required col-md-6">
                        ...
                        <input type="text" class="form-control required" id="first_name" name="first_name" placeholder=""  value="<?= @$employee->first_name ?>">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="surname" name="surname" placeholder=""  value="<?= @$employee->surname ?>">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Title</label>
                        <input type="text" class="form-control" id="title" name="title" placeholder=""  value="<?= @$employee->title ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="saludation" name="saludation" placeholder=""  value="<?= @$employee->saludation ?>">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group required col-md-6">
                        ...
                        <input type="text" class="form-control required email" id="email" name="email" placeholder=""  value="<?= @$employee->email ?>">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="direct_phone" name="direct_phone" placeholder=""  value="<?= @$employee->direct_phone ?>">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="direct_fax" name="direct_fax" placeholder=""  value="<?= @$employee->direct_fax ?>">
                    </div>
                    ...
                    <div class="form-check checkbox-section col-md-3">
                        ...
                        <input class="form-check-input" name="allow_web_access" id="allow_web_access" value="<?php echo @$employee->allow_web_access; ?>" type="checkbox" <?php if(@$employee->allow_web_access == "1"){echo 
                            "checked"; }?>>
