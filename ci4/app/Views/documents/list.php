                        ...
                        <div class="header_more_tool">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" id="copyToClipBoard" link='<?=!empty($row['file'])?str_replace("https://webimpetus-images.s3.eu-west-2.amazonaws.com", base_url(), $row['file']):'';?>'> <i class="fas fa-copy"></i> Copy Link</a>
                                </div>
                            </div>
                        </div>
                    </td>   
