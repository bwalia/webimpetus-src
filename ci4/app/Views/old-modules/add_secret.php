                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="card-body">
                                ...
                                <form id="adddomain" method="post" action="/secrets/save" enctype="multipart/form-data">
                                   <div class="form-row">								
										
										
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Secret Key</label>
                                            <input type="text" class="form-control" id="title" name="key_name" placeholder="">
                                        </div>

                                          
                                         <div class="form-group col-md-12">
                                            <label for="inputPassword4">Secret Value</label>
                                          <textarea class="form-control" name="key_value" style="width:100%!important;height:250px" ></textarea> 
                                        </div>
