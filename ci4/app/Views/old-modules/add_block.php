                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="card-body">
                                ...
                                <form id="adddomain" method="post" action="/blocks/save" enctype="multipart/form-data">
                                   <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                         ...
                                         <div class="form-group col-md-12">
                                          ...
                                          <textarea class="form-control" name="text" style="width:100%!important;height:250px" ></textarea> 
                                        </div>
