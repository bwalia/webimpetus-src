                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page_title_left d-flex align-items-center">
                            <h3 class="f_s_25 f_w_700 dark_text mr_30" >Enquiries </h3>
                            <ol class="breadcrumb page_bradcam mb-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                                <li class="breadcrumb-item active">Enquiries List</li>
                            </ol>
                        </div>
                        <div class="page_title_right">
                          <?php if(!empty($_SESSION['role'])){ ?>
                            ...
                            <a href="/enquiries/add" class="btn btn-primary"><i class="ti-plus"></i> Add job</a>
						  </div--> <?php } ?>
                    ...
                    <div class="white_card card_height_100 mb_20 ">
                        ...
                        <div class="white_card_body ">
                            <div class="QA_table table-responsive ">
                                <!-- table-responsive -->
                                <table id="example"  class="table table-listing-itemstableDocument table-bordered table-hover">
                                    <thead>
                                        <tr>
