                ...
                <div class="col-12">
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="page_title_right">
                            ...
                            <a href="/templates/add" class="btn btn-primary"><i class="ti-plus"></i> Add Template</a>
						  </div>
                                            ...
                                            <div class="header_more_tool">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                      ...
                                                      <a class="dropdown-item" onclick="return confirm('Are you sure want to delete?');" href="/templates/delete/<?= $row['id'];?>"> <i class="ti-trash"></i> Delete</a>
                                                      <a class="dropdown-item" href="/templates/edit/<?= $row['id'];?>"> <i class="fas fa-edit"></i> Edit</a>
