				...
				<div class="col-xs-12 col-md-12">
					<nav>
						<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
							...
							<!-- Added New  > -->
							<a class="nav-item nav-link" id="nav-picture-tab" data-toggle="tab" href="#nav-picture" role="tab" aria-controls="nav-picture" aria-selected="false">Pictures</a>
							<!-- Added New  | -->
							<a class="nav-item nav-link" id="nav-setup-tab" data-toggle="tab" href="#nav-setup" role="tab" aria-controls="nav-setup" aria-selected="false">Setup</a>
							<!-- Added New  > -->
									...
									?>
										<div class="form-row col-md-12 each-row each-block" style="margin-bottom:30px;" id="office_address_<?php echo $new_id; ?>">
											<div class="form-group col-md-6">
												...
												<select name="block_type[]" id="text_type" class="form-control text_type">
