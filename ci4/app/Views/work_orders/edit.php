                                        ...
                                        <div class="col-md-6">
                                            <select id="template" name="template" class="form-control  dashboard-dropdown">
                                                ...
                                                <?php foreach ($templates as $row) : ?>
                                                    <option value="<?= $row['id']; ?>" <?php if ($row['id'] == @$work_order->template) {
                                                                                            echo "selected";
                                                                                        } ?>><?= $row['code']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <select name="status" id="status" class="form-control dashboard-dropdown">
                                                <?php foreach ($status as $key => $value) : ?>
                                                    <option value="<?= $key; ?>" <?php if ($key == @$work_order->status) {
                                                                                        echo "selected";
                                                                                    } ?>><?= $value; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                                    ...
                                                    <?php foreach ($items as $eachItems) { ?>
                                                        <tr class="item-row" id="<?= $eachItems->id ?>">
                                                            ...
                                                            <td data-th="Rate"><span class="bt-content">
                                                                    ...
                                                                    <input type="text" class="rate num form-control" style="display: none;width:100%" value="<?= $eachItems->rate ?>">
                                                                </span></td>
                                                            ...
                                                            <td data-th="Discount"><span class="bt-content">
                                                                    ...
                                                                    <input type="text" class="discount num form-control" style="display: none;" value="<?= $eachItems->discount ?>">
                                                                </span></td>
                                    ...
                                    <div class="row form-group row-space ">
                                        ...
                                        <div class="col-md-6">
                                            <select id="currency_code" name="currency_code" class="form-control dashboard-dropdown">
                                                <option value="">--Please Select--</option>
                                                <option value="AUD" <?= @$work_order->currency_code == 'AUD' ? 'selected' : '' ?>>AUD</option>
                                                <option value="EUR" <?= @$work_order->currency_code == 'EUR' ? 'selected' : '' ?>>EUR</option>
                                                <option value="GBP" <?= @$work_order->currency_code == 'GBP' ? 'selected' : '' ?>>GBP</option>
                                                <option value="INR" <?= @$work_order->currency_code == 'INR' ? 'selected' : '' ?>>INR</option>
                                                <option value="USD" <?= @$work_order->currency_code == 'USD' ? 'selected' : '' ?>>USD</option>
                                            </select>
                                        </div>
                                    </div>
